export default function validate(input, pokemons){
    ...
    if(input.health < 1 || input.health > 150){
        if(input.health < 1 ){
            errors.health = 'The life of the Pokemon must be higher than 1'
        }
        if( input.health > 150){
            errors.health = 'The life of the Pokemon must be less than 150'
        } 
    }
